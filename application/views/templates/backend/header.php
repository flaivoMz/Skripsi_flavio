...
<head>
    ...
    <script src="<?= base_url('assets/') ?>global_assets/js/demo_pages/charts/echarts/pies_donuts_backend.js"></script>
    ...
    <script src="<?= base_url('assets/') ?>global_assets/js/demo_pages/editor_ckeditor.js"></script>
    <script src="<?= base_url('assets/') ?>global_assets/js/demo_pages/form_select2.js"></script>
    <script src="<?= base_url('assets/') ?>global_assets/js/demo_pages/form_inputs.js"></script>
