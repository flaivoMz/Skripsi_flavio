...
<head>
    ...
    <link href="<?= base_url('assets/backend/') ?>global_assets/css/icons/fontawesome/styles.min.css" rel="stylesheet" type="text/css">
    ...
    <!-- Theme JS files -->
    <script src="<?= base_url('assets/backend/') ?>global_assets/js/plugins/notifications/sweet_alert.min.js"></script>
    <script src="<?= base_url('assets/backend/') ?>global_assets/js/plugins/forms/selects/select2.min.js"></script>
    <script src="<?= base_url('assets/backend/') ?>global_assets/js/plugins/ui/moment/moment.min.js"></script>
    <script src="<?= base_url('assets/backend/') ?>global_assets/js/plugins/pickers/daterangepicker.js"></script>
    <script src="<?= base_url('assets/backend/') ?>global_assets/js/plugins/tables/datatables/datatables.min.js"></script>
    ...
    <script src="<?= base_url('assets/backend/') ?>global_assets/js/demo_pages/editor_ckeditor.js"></script>
    <script src="<?= base_url('assets/backend/') ?>global_assets/js/demo_pages/form_select2.js"></script>
    <script src="<?= base_url('assets/backend/') ?>global_assets/js/demo_pages/form_inputs.js"></script>
